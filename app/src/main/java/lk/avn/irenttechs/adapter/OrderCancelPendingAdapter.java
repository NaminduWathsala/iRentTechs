...
public class OrderCancelPendingAdapter extends RecyclerView.Adapter<OrderCancelPendingAdapter.ViewHolder>  {
    ...
    @NonNull
    @Override
    public OrderCancelPendingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.order_cancel_view, parent, false);
        return new OrderCancelPendingAdapter.ViewHolder(view, listener);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderCancelPendingAdapter.ViewHolder holder, int position) {
