...
public class OrderOngoingAdapter extends RecyclerView.Adapter<OrderOngoingAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public OrderOngoingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.order_cancel_view, parent, false);
        return new OrderOngoingAdapter.ViewHolder(view, listener);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderOngoingAdapter.ViewHolder holder, int position) {
