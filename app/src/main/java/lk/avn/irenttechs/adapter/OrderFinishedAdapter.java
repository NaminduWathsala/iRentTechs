...
public class OrderFinishedAdapter extends RecyclerView.Adapter<OrderFinishedAdapter.ViewHolder>  {
    private List<Invoice> invoices;
    private Context context;
    private OnItemClickListener listener;


    public OrderFinishedAdapter(List<Invoice> invoices, Context context, OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public OrderFinishedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.order_cancel_view, parent, false);
        return new OrderFinishedAdapter.ViewHolder(view, listener);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderFinishedAdapter.ViewHolder holder, int position) {
