...
import lk.avn.irenttechs.adapter.OrderCancelPendingAdapter;
import lk.avn.irenttechs.adapter.OrderFinishedAdapter;
...
public class OrderCancelPendingFragment extends Fragment {


    private static final String TAG = OrderCancelPendingFragment.class.getName();
    Bundle args;
    ...
    private static OrderCancelPendingAdapter orderCancelPendingAdapter;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_order_cancel_pending, container, false);
    }
    ...
    public void onViewCreated(@NonNull View fragment, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView invoiceView = fragment.findViewById(R.id.order_cancel_pending_rv);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        orderCancelPendingAdapter = new OrderCancelPendingAdapter(invoices, getContext(), new OrderCancelPendingAdapter.OnItemClickListener() {
            @Override
        ...
        invoiceView.setAdapter(orderCancelPendingAdapter);

        CollectionReference wishlistCollection = firestore.collection("Invoice");
        Query wishlist_query = wishlistCollection.whereEqualTo("user_email", email).whereEqualTo("status","cancel_pending");
                ...
                for (QueryDocumentSnapshot doc : task.getResult()) {
                    ...
                    query.addSnapshotListener(new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                            ...
                            orderCancelPendingAdapter.notifyDataSetChanged();
                        }
                    });
                }
            }
